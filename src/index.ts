...
export type WebhookConfig = Omit<RouteConfigBase, 'path'> & {
  path: string
  hide?: boolean
}
...
> extends Hono<E, S, BasePath> {
  ...
  /**
   * Register a webhook definition for OpenAPI documentation.
   * Webhooks are endpoints that your API expects to receive data from external services.
   *
...
export const createWebhook = <
  P extends string,
  W extends Omit<WebhookConfig, 'path'> & { path: P },
>(
  webhookConfig: W
): W => {
